...
<template>
  <!-- component -->
  <div class="min-h-screen w-screen flex bg-gray-200">
    <!-- container -->
    ...
    <nav class="fixed bottom-0 w-full border bg-white lg:hidden flex overflow-x-auto">
      ...
      <a
        href="."
        class="flex flex-col flex-grow items-center justify-center overflow-hidden whitespace-no-wrap text-sm transition-colors duration-100 ease-in-out hover:bg-gray-200 text-orange-500"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
